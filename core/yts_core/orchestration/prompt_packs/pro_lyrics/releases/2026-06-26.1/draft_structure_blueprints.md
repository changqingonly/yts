...
- 对象，且只能包含 first_appearance、repeat_sections、strategy、reason、notes；first_appearance 必须是 sections 中的英文段落名，repeat_sections 必须是 sections 中英文段落名数组，文字说明字段必须是非空字符串。
